...
%pd=3:10:43
b=122:1:141; % repetitions for the fire series (each number is a random number that corresponds to a fire sequence)
...
%       StoreMatPine(NrStore)= MatPine;
        ...
        %%%%%% MULTIRUNS CODE
        filename=strcat(['firePT_F30HS_BIRS_FS',num2str(BirdSeedNv),'_',num2str(irun),'_',num2str(b),'.mat' ]);
