...
for k=1:length(BirdSeedNv)
       for irun=1:nruns
           filename=strcat(['./firePT_F30LS_BIRS_OS',num2str(BirdSeedNv(k)),'_',num2str(irun),'.mat' ]);%loads the file in the current directory %%name of directory should correspond; can load many directories
