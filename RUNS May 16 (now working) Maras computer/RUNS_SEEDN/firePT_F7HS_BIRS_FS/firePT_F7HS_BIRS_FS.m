...
%pd=3:10:43
b=122; % repetitions for the fire series (each number is a random number that corresponds to a fire sequence)
...
%       StoreMatPine(NrStore)= MatPine;
        ...
        %%%%%% MULTIRUNS CODE
        filename=strcat(['firePT_F7HS_BIRS_FS',num2str(BirdSeedN),'_',num2str(irun),'_',num2str(b),'.mat' ]);,'.mat' ]);
